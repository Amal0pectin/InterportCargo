...
namespace Interport_Amal.Migrations
{
    ...
    [Migration("20250607094124_UpdatedQuotationRepository")]
    partial class UpdatedQuotationRepository
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Interport_Amal.BusinessLogic.Entities.Quotation", b =>
                {
                    ...
                    b.Property<int?>("QuotationRequestId1")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("QuotationRequestId1");
            ...
            modelBuilder.Entity("Interport_Amal.BusinessLogic.Entities.Quotation", b =>
                {
                    ...
                    b.HasOne("Interport_Amal.BusinessLogic.Entities.QuotationRequest", null)
                        .WithMany("Quotation")
                        .HasForeignKey("QuotationRequestId1");
